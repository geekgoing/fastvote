...
export const messages = {
  ko: {
    ...
    create: {
      ...
      expiresLabel: "투표 기간",
      expiresHint: "지정된 시간이 지나면 투표가 종료됩니다",
      expiresOptions: [
        { value: "1", label: "1시간" },
        { value: "6", label: "6시간" },
        { value: "12", label: "12시간" },
    ...
    vote: {
      ...
      expiresIn: (hours: number) => hours === 1 ? "1시간 후 만료" : `${hours}시간 후 만료`,
  ...
  en: {
    ...
    create: {
      ...
      expiresLabel: "Poll Duration",
      expiresHint: "Poll will close after the specified time",
      expiresOptions: [
    ...
    vote: {
      ...
      liveBadge: "Live Vote",
      protected: "Protected",
      totalVotes: (count: number) => `${count} voted`,
      expiresIn: (hours: number) => hours === 1 ? "Expires in 1 hour" : `Expires in ${hours} hours`,
